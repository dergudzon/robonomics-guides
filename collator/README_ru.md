# Как запустить коллатор Робономики
Протестировано на:
  - Ubuntu 24.04.4
...
В парачейне Robonomics каждый коллатор получает вознаграждение (**0.001598184 XRT**) за каждый собранный им блок, который финализирован в цепочке блоков.
Также этому коллатору, назначается **50% от комиссий за транзакции**, содержащиеся в собранном им блоке.
...
+ **${POLKADOT_ACCOUNT_ADDRESS}** - адрес вашего аккаунта в сети Robonomics, на который будут приходить награды за сборку блоков, в формате SS58. Пример: `4Gp3QpacQhp4ZReGhJ47pzExQiwoNPgqTWYqEQca9XAvrYsu`
