---
title: Launch of Robonomics Public Node
...
A public node is part of the Robonomics parachain. This type of node 

 {% roboWikiNote {type: "okay"}%}

 {% endroboWikiNote %}  

You can learn more about public nodes on the related [Polkadot wiki page](https://wiki.polkadot.network/docs/learn-collator).
